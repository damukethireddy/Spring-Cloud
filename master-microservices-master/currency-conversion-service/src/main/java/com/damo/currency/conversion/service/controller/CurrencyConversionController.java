...
public class CurrencyConversionController {
	...
	public CurrencyConversionController(RestTemplateBuilder restTemplateBuilder) {
	...
	public CurrencyConversionBean convertCurrency(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity) {
		...
		ResponseEntity<CurrencyConversionBean> responseEntity = restTemp.getForEntity("http://localhost:8000/currency-exchange/from/{from}/to/{to}", CurrencyConversionBean.class, uriVariables );
